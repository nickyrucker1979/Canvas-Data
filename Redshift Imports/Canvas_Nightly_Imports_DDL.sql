 ...
 with cte as
  (
    select
      ...
      dtd.MESSAGE                                      as DISCUSSION_TOPIC_MESSAGE,
    ...
    from
      CANVAS_DATA_NIGHTLY_IMPORTS.DISCUSSION_TOPIC_DIM dtd
      join CANVAS_DATA_NIGHTLY_IMPORTS.DISCUSSION_TOPIC_FACT dtf
      ...
      left join CANVAS_DATA_NIGHTLY_IMPORTS.USER_DIM ud2
        on dtf.USER_ID = ud2.ID
      left join CANVAS_DATA_NIGHTLY_IMPORTS.USER_DIM ud3
